      ...
      return (
        <main className="container">
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                <h6 class="border-bottom pb-2 mb-0">About Sol Tracker</h6>
                <div class="d-flex text-muted pt-3 text-black">
                
                    <p class="pb-3 mb-0 lh-sm border-bottom h6 mt-3 pb-4 text-black">
                ...
                <p class="pb-3 mb-0 lh-sm h6 mt-4 text-black">
